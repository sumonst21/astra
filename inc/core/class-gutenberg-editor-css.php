		...
		public static function get_css() {
			...
			if ( 'custom' === $single_post_max ) :
				...
				$single_blog_css = array(
					'.gutenberg-editor-page.post-type-post #wpwrap .edit-post-visual-editor .editor-post-title__block, .gutenberg-editor-page.post-type-post #wpwrap .edit-post-visual-editor .editor-default-block-appender' => array(
