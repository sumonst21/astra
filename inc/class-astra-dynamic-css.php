	...
	class Astra_Dynamic_CSS {
		...
		public static function return_output() {
			...
			$submenu_border_style = array(
				'.ast-desktop .main-header-menu.submenu-with-border .ast-sub-menu, .ast-desktop .main-header-menu.submenu-with-border .ast-sub-menu .ast-menu-item, .ast-desktop .main-header-menu.submenu-with-border .astra-full-megamenu-wrapper' => array(
					'border-color' => esc_attr( $primary_submenu_b_color ),
				),

				'.ast-desktop .main-header-menu.submenu-with-border .ast-sub-menu' => array(
				...
				'.ast-desktop .main-header-menu.submenu-with-border .ast-sub-menu .ast-sub-menu' => array(
					'top' => ( isset( $submenu_border['top'] ) && '' != $submenu_border['top'] ) ? astra_get_css_value( '-' . $submenu_border['top'], 'px' ) : '',
				),
				'.ast-desktop .main-header-menu.submenu-with-border .ast-sub-menu .ast-menu-item' => array(
