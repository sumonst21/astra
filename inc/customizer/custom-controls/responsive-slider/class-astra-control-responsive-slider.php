...
class Astra_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'astra-responsive-slider', $js_uri . 'responsive-slider' . $file_prefix . '.js', array( 'jquery', 'customize-base' ), ASTRA_THEME_VERSION, true );
		wp_enqueue_style( 'astra-responsive-slider', $css_uri . 'responsive-slider' . $file_prefix . '.css', null, ASTRA_THEME_VERSION );
	}
