...
class Astra_Control_Responsive extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'astra-responsive', $js_uri . 'responsive' . $file_prefix . '.js', array( 'jquery', 'customize-base' ), ASTRA_THEME_VERSION, true );
		wp_enqueue_style( 'astra-responsive-css', $css_uri . 'responsive' . $file_prefix . '.css', null, ASTRA_THEME_VERSION );
