...
if ( ! class_exists( 'Astra_Control_Background' ) && class_exists( 'WP_Customize_Control' ) ) :
	...
	class Astra_Control_Background extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_style( 'astra-background', $css_uri . 'background' . $file_prefix . '.css', null, ASTRA_THEME_VERSION );
			wp_enqueue_script( 'astra-background', $js_uri . 'background' . $file_prefix . '.js', array(), ASTRA_THEME_VERSION, true );
			wp_localize_script(
				'astra-background',
