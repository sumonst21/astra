...
( function( $ ) {
	...
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-menu]', 'transparent-menu-bg-color-responsive', '.ast-theme-transparent-header .ast-above-header-menu, .ast-theme-transparent-header.ast-header-break-point .ast-above-header-section-separated .ast-above-header-navigation ul.ast-above-header-menu, .ast-flyout-above-menu-enable.ast-header-break-point.ast-theme-transparent-header .ast-above-header-navigation-wrap .ast-above-header-navigation, .ast-fullscreen-above-menu-enable.ast-header-break-point.ast-theme-transparent-header .ast-above-header-section-separated .ast-above-header-navigation-wrap', 'background-color', 'transparent-above-header' );
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-menu]', 'transparent-menu-color-responsive', '.ast-theme-transparent-header .ast-above-header-navigation a, .ast-theme-transparent-header .ast-above-header-navigation li > .ast-menu-toggle', 'color', 'transparent-above-header' );
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-menu]', 'transparent-menu-h-color-responsive', '.ast-theme-transparent-header .ast-above-header-navigation li.current-menu-item > a,.ast-theme-transparent-header .ast-above-header-navigation li.current-menu-ancestor > a, .ast-theme-transparent-header .ast-above-header-navigation li:hover > a, .ast-theme-transparent-header .ast-above-header-navigation li.current-menu-item > .ast-menu-toggle', 'color' )
