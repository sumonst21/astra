...
( function( $ ) {
	...
	wp.customize( 'astra-settings[primary-submenu-border]', function( value ) {
		value.bind( function( border ) {
			...
			if( '' != border.top || '' != border.right || '' != border.bottom || '' != border.left ) {
				...
				var dynamicStyle = '.ast-desktop .main-header-menu.submenu-with-border .ast-sub-menu';
					dynamicStyle += '{';
					...
					dynamicStyle += '.ast-desktop .main-header-menu.submenu-with-border .ast-sub-menu .ast-sub-menu';
					dynamicStyle += '{';
					...
					dynamicStyle += '.main-header-menu .ast-sub-menu li.ast-left-align-sub-menu:hover > .ast-sub-menu, .main-header-menu .ast-sub-menu li.ast-left-align-sub-menu.focus > .ast-sub-menu';
					dynamicStyle += '{';
		...
		value.bind(function (color) {
			...
			if ('' != color) {
				if ( true == insideBorder ) {
					...
					dynamicStyle += '.ast-desktop .main-header-menu.submenu-with-border .ast-sub-menu .ast-menu-item';
					dynamicStyle += '{';
	...
	wp.customize( 'astra-settings[primary-submenu-item-border]', function( value ) {
		value.bind( function( border ) {
			...
			if( true === border  ) {
				var dynamicStyle = '.ast-desktop .main-header-menu.submenu-with-border .ast-sub-menu .ast-menu-item';
					dynamicStyle += '{';
